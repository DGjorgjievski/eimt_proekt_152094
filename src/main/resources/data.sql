...
INSERT INTO local (id, name, location, total_spaces, local_image) VALUES (nextval('local_seq'), 'Cafe Li', 'Skopje', 1, 'https://img.freepik.com/premium-vector/chef-restaurant-logo-inspiration_139869-449.jpg?w=2000');
INSERT INTO local (id, name, location, total_spaces, local_image) VALUES (nextval('local_seq'), 'Circle', 'Skopje', 2, 'https://img.freepik.com/premium-vector/chef-restaurant-logo-inspiration_139869-449.jpg?w=2000');
INSERT INTO local (id, name, location, total_spaces, local_image) VALUES (nextval('local_seq'), 'Casa', 'Skopje', 2, 'https://img.freepik.com/premium-vector/chef-restaurant-logo-inspiration_139869-449.jpg?w=2000');
INSERT INTO local (id, name, location, total_spaces, local_image) VALUES (nextval('local_seq'), 'Cube', 'Skopje', 5, 'https://img.freepik.com/premium-vector/chef-restaurant-logo-inspiration_139869-449.jpg?w=2000');
INSERT INTO local (id, name, location, total_spaces, local_image) VALUES (nextval('local_seq'), 'Vox', 'Skopje', 7, 'https://img.freepik.com/premium-vector/chef-restaurant-logo-inspiration_139869-449.jpg?w=2000');
